          ...
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="glass-card p-8 md:p-12 rounded-3xl space-y-6 animate-fade-up">
              ...
              <p className="text-lg md:text-xl text-white/80 leading-relaxed">
                Founded with a vision to create a safe, empowering space for women in Nashik, Zin Shreya's Academy has been transforming lives for over 7 years. What started as a passion for fitness and dance has grown into one of Nashik's most trusted female fitness destinations.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center space-y-8 animate-fade-up">
            ...
            <p className="text-xl text-white/80">
              Join hundreds of women who have transformed their lives at Zin Shreya's Academy
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center pt-4">
              ...
              <Link to="/contact">
                <Button size="lg" variant="outline" className="btn-outline text-lg px-8 py-6 h-auto">
                  CONTACT US
                </Button>
              </Link>
            </div>
